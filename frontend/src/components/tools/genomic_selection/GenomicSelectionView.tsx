...
const GenomicSelectionView: React.FC = () => {
  return (
    <ToolLayoutWrapper 
      header={
        <div>
          <h1 style={{ margin: 0, fontSize: '1.5rem', color: '#646cff' }}>Genomic Selection Optimizer</h1>
          <p style={{ margin: '0.5rem 0 0', color: '#aaa' }}>Optimize selection index using genomic estimated breeding values.</p>
        </div>
      }
...
export default GenomicSelectionView;
